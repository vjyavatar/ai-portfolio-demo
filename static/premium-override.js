...
;window._institutionalDashboard=function(d,S){
  ...
  _oldLayers.forEach(function(l,idx){
    ...
    // Layman inference line
    h+='<div style="padding:2px 0 0 22px;font-size:8px;color:#6b7280;line-height:1.4">'+inference+'</div>';
    h+='</div>';
  });
  ...
  layers.forEach(function(layer,idx){
    ...
    h+='</div></div>';
    // Row 2: Layman inference
    h+='<div style="padding:0 0 4px 28px;font-size:8px;color:#374151;line-height:1.4">'+inference+'</div>';
